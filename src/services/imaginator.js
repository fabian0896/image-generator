...
class Imaginator {
    ...
    async init(values) {
		...
		this.dividerSVG = dividerSVG
		this.whatsappSVG = whatsappSVG
        ...
        await this.loadSVG(this.dividerSVG ,{
            top: -20,
            scaleY: 2.5,
            scaleX: 1,
            left: INFO_WIDTH,
        ...
        await this.loadSVG(this.logoSVG,{
            lockMovementX: true,
            left: PADDING,
            top: PADDING * 2,
            selectable: true
        ...
        const whatsappLogoObject = await this.loadSVG(this.whatsappSVG ,{
            lockMovementX: true,
            left: PADDING,
            selectable: false
        }, obj => {
